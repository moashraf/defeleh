...
class companycategoryController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.companycategories.index')
    ...
    public function create()
    {
        ...
        return view('admin.companycategories.create')->with('companies_cat', $companies_cat);
 ...
 if (!empty($request->file('image'))){
    ...
    public function show($id)
    {
        ...
        return view('admin.companycategories.show')->with('companycategory', $companycategory);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.companycategories.edit')->with('companies_cat', $companies_cat)->with('companycategory', $companycategory);
    }
