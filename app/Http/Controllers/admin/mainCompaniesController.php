...
class mainCompaniesController extends AppBaseController
{
    ...
    public function cat($cat)
    {
        ...
        return view('admin.companies.all_cat_companies')
            ->with('companies', $companies);
    }
    ...
    public function create()
    {
        ...
        return view('admin.companies.add_companies')->with('companies_cat', $companies_cat);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.companies.single_companies')->with('company', $company);
    }
